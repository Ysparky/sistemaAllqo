...
namespace sistemaAllqo.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idServicio,categoria,descripcion,precio")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idServicio,categoria,descripcion,precio")] Servicio servicio)
        {
